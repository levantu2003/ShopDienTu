...
public class DangKy extends javax.swing.JFrame {
    ...
    public DangKy() {
        ...
        pnDangKy.setBackground(new Color(175, 217, 243, 196));
    }
    ...
    private void initComponents() {
        ...
        lbDangKy.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icon2/user.png"))); // NOI18N
        ...
        getContentPane().add(pnDangKy, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, 560, 350));
    ...
    private void btnSignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignUpActionPerformed
        kiemtraHopLe(txtEmail, txtMatKhau, txtMatKhauAgain, this);
        String email = txtEmail.getText();
        String matKhau = String.valueOf(txtMatKhau.getPassword());

        MaHoaMD5 md5 = new MaHoaMD5();
        String hashedPassword = md5.hashPassword(matKhau);

        DAO.XacThuc.DangNhapDAO dangNhapDAO = new DAO.XacThuc.DangNhapDAO();
        String newMaND = dangNhapDAO.getNewMaND();

        NguoiDung nguoiDungMoi = new NguoiDung(newMaND, email, hashedPassword);

        DangKyDAO dangKyDAO = new DangKyDAO();

        boolean success = dangKyDAO.themNguoiDung(nguoiDungMoi);
    ...
    public static void kiemtraHopLe(JTextField txtEmail, JTextField txtMatKhau, JTextField txtMatKhauAgain, JFrame pnDangKy) {
        try {
